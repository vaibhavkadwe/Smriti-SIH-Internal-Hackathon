...
DEFAULT_DAILY_ROUTINE: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "order": 3,
        "time": "07:15",
        "title_en": "Morning Tea & Light Snack",
        "title_as": "পুৱাৰ চাহ আৰু জলপান",
        "title_bn": "সকালের চা ও জলখাবার",
        "title_hi": "सुबह की चाय और नाश्ता",
        "icon": "coffee",
        "hint": "A warm cup of Assam tea with biscuit.",
    },
    {
